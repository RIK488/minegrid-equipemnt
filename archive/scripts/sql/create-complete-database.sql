-- Script complet pour créer la structure de la base de données
-- Exécutez ce script dans l'ordre pour créer toutes les tables nécessaires
...
-- =====================================================
-- 3. TABLE DES UTILISATEURS CLIENTS
-- =====================================================
...
CREATE TABLE IF NOT EXISTS client_notifications (
  ...
  related_entity_type VARCHAR(50), -- 'equipment', 'order', 'maintenance', 'document'
...
CREATE POLICY "Users can view own pro client" ON pro_clients
  FOR SELECT USING (auth.uid() = user_id);

CREATE POLICY "Users can update own pro client" ON pro_clients
...
-- Insérer un client de test (optionnel)
-- INSERT INTO pro_clients (user_id, company_name, email) 
-- VALUES ('your-user-id', 'Test Company', 'test@example.com');

-- Insérer un utilisateur client de test (optionnel)
-- INSERT INTO client_users (client_id, user_id, role) 
-- VALUES ('client-id', 'your-user-id', 'admin'); 