...
function getInlandRegion(origin) {
...
export function calculateCustomsDuties(country, cifValue) {
...
export function estimerTransport(depart, arrivee, poids, volume, valeurMachine) {
...
export function getDestinationsFromOrigin(origin) {
...
export function getOriginsToDestination(destination) {
    return availableOrigins.filter(origin => transportTable[origin] && transportTable[origin][destination]);
}
...
export function getCostBreakdown(cost) {
...
export function getOriginsByContinent() {
    return {
